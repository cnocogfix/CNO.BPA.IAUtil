...
namespace CNO.BPA.IAUtil
{
   ...
   public sealed class Module : IModule, IModuleInformation
   {
      ...
      // Export.mdf file.
      //----------------------------------------------------------------
      private const int MODULE_ID = 4561;
      private const string MODULE_MDF_NAME = "BPAUTIL1";                 // 8 character maximum
      private const string MODULE_SHORT_TITLE = "IA BPA Utilities 1";          // 31 character maximum
      private const string MODULE_LONG_TITLE = "IA BPA Utilities Custom Module 1";
      ...
      public void Initialize(IHelper helper, IModuleOptions options)
      {
         ...
         pm = new ProcessModule(quickModulehelper, "BPAUtil1");
         //---------------------------------------------------------------- 
         // Module Options
         // 
