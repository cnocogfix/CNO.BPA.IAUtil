...
namespace CNO.BPA.IAUtil
{
   ...
   public sealed class Module : IModule, IModuleInformation
   {
      ...
      // Export.mdf file.
      //----------------------------------------------------------------
      private const int MODULE_ID = 4562;
      private const string MODULE_MDF_NAME = "BPAUTIL2";                 // 8 character maximum
      private const string MODULE_SHORT_TITLE = "IA BPA Utilities 2";          // 31 character maximum
      private const string MODULE_LONG_TITLE = "IA BPA Utilities Custom Module 2";
      ...
      public void Initialize(IHelper helper, IModuleOptions options)
      {
         ...
         pm = new ProcessModule(quickModulehelper, "BPAUtil2");
         //---------------------------------------------------------------- 
         // Module Options
         // 
