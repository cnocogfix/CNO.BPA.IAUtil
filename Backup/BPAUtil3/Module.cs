...
namespace CNO.BPA.IAUtil
{
   ...
   public sealed class Module : IModule, IModuleInformation
   {
      ...
      // Export.mdf file.
      //----------------------------------------------------------------
      private const int MODULE_ID = 4563;
      private const string MODULE_MDF_NAME = "BPAUTIL3";                 // 8 character maximum
      private const string MODULE_SHORT_TITLE = "IA BPA Utilities 3";          // 31 character maximum
      private const string MODULE_LONG_TITLE = "IA BPA Utilities Custom Module 3";
