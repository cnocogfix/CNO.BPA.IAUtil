         ...
         try
         {
            ...
            using (objConn)
            {
               ...
               DBUtilities.CreateAndAddParameter("p_in_site",
                  _taskValueProvider.Get("siteID",""), OracleType.VarChar, ParameterDirection.Input, cmd);

               DBUtilities.CreateAndAddParameter("p_in_sort_code",
                  _taskValueProvider.Get("sortCode",""), OracleType.VarChar, ParameterDirection.Input, cmd);

               DBUtilities.CreateAndAddParameter("p_in_form_name",
                  _taskValueProvider.Get("formType",""), OracleType.VarChar, ParameterDirection.Input, cmd);

               DBUtilities.CreateAndAddParameter("p_in_va_tin",
                  _taskValueProvider.Get("vaTIN",""), OracleType.VarChar, ParameterDirection.Input, cmd);

               DBUtilities.CreateAndAddParameter("p_in_tob",
                  _taskValueProvider.Get("typeOfBill",""), OracleType.VarChar, ParameterDirection.Input, cmd);

               DBUtilities.CreateAndAddParameter("p_in_hcfa_count",
                  _taskValueProvider.Get("countHCFA",""), OracleType.VarChar, ParameterDirection.Input, cmd);

               DBUtilities.CreateAndAddParameter("p_in_ub92_count",
                 _taskValueProvider.Get("countUB92",""), OracleType.VarChar, ParameterDirection.Input, cmd);

               DBUtilities.CreateAndAddParameter("p_in_eomb_count",
                  _taskValueProvider.Get("countEOMB",""), OracleType.VarChar, ParameterDirection.Input, cmd);

               DBUtilities.CreateAndAddParameter("p_in_pheomb_count",
                  _taskValueProvider.Get("countPHEOMB",""), OracleType.VarChar, ParameterDirection.Input, cmd);

               DBUtilities.CreateAndAddParameter("p_in_policy_number",
                  _taskValueProvider.Get("policyNo",""), OracleType.VarChar, ParameterDirection.Input, cmd);

               DBUtilities.CreateAndAddParameter("p_in_company_code",
                  _taskValueProvider.Get("companyCode", ""), OracleType.VarChar, ParameterDirection.Input, cmd);
